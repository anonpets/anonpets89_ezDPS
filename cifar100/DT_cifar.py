...
if __name__ == '__main__':
    ...
    filename_pac = 'pca_dt_class16.sav'
    ...
    t0 = time()
    train_sub_sub_data = pca.transform(train_sub_sub_data)
    ...
    # 预测
    # 使用DWT处理数据
    test_sub_sub_data = wavelets_f(test_sub_sub_data)
    # 使用PCA处理数据
    test_sub_sub_data = pca.transform(test_sub_sub_data)
    # 预测
